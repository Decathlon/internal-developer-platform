...
class EntityTemplateControllerTest extends AbstractIntegrationTest {
    ...
    class DeleteTemplateTests {
        ...
        /**
         * Tests the DELETE /api/v1/entity-templates/{id} endpoint security when CSRF
         * token is missing.
         *
         * <p>
         * This test verifies that:
         * </p>
         * <ul>
         * <li>Missing CSRF token results in HTTP 403 Forbidden status</li>
         * <li>CSRF protection is properly enforced for DELETE operations</li>
