...
class JpaPredicateBuilderTest {
  ...
  class EscapeLikeWildcardsTests {
    ...
    void escapes_percent() {
      assertThat(JpaPredicateBuilder.escapeLikeWildcards("100%")).isEqualTo("100\\%");
    }

    @Test
    @DisplayName("escapes underscore")
    void escapes_underscore() {
      assertThat(JpaPredicateBuilder.escapeLikeWildcards("my_value")).isEqualTo("my\\_value");
    }
    ...
    void leaves_plainString_unchanged() {
      assertThat(JpaPredicateBuilder.escapeLikeWildcards("hello")).isEqualTo("hello");
    }
