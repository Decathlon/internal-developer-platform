...
class EntitySpecificationTest {
  ...
  class EscapeLikeWildcardsTests {
    ...
    void escapes_percent() {
      assertThat(EntitySpecification.escapeLikeWildcards("100%")).isEqualTo("100\\%");
    }

    @Test
    @DisplayName("escapes underscore")
    void escapes_underscore() {
      assertThat(EntitySpecification.escapeLikeWildcards("my_value")).isEqualTo("my\\_value");
    }
    ...
    void leaves_plainString_unchanged() {
      assertThat(EntitySpecification.escapeLikeWildcards("hello")).isEqualTo("hello");
    }
    ...
    void escapes_wildcardCombinations(String input) {
      ...
      assertThat(stripped).doesNotContain("%").doesNotContain("_");
