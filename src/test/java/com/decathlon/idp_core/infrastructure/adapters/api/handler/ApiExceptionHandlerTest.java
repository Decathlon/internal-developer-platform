  ...
  class DomainExceptionTests {
    ...
    class ValidationExceptionTests {
      ...
      void shouldHandleEntityDynamicMappingConfigurationException() {
        ...
        assertNotNull(body);
        assertEquals(HttpStatus.BAD_REQUEST.name(), body.getError());
        assertEquals("Invalid webhook mapping configuration: " + details,
      ...
      void shouldHandleWebhookTemplateHasNoPropertiesException() {
        ...
        WebhookTemplateHasNoPropertiesException exception = new WebhookTemplateHasNoPropertiesException(
            details);

        ResponseEntity<ErrorResponse> response = exceptionHandler
            .handleWebhookTemplateHasNoPropertiesException(exception);
