  ...
  class GetTemplatesPaginatedTests {
    ...
    void getTemplates_paginated_200() throws Exception {
      ...
      mockMvc.perform(get("/api/v1/entity-templates").accept(APPLICATION_JSON))
          ...
          .andExpect(jsonPath("$.content.length()").value(14))
          .andExpect(jsonPath("$.content[1].identifier").value("batch-job"))
          .andExpect(jsonPath("$.page.total_elements").value(14))
  ...
  class PutTemplateTests {
    ...
    void putTemplate_400_name_missing() throws Exception {
      ...
      mockMvc.perform(MockMvcRequestBuilders.put(ENTITY_TEMPLATE_PATH + "/" + identifier)
          ...
          .andExpect(status().isBadRequest()).andExpect(jsonPath("$.error").value("BAD_REQUEST"))
          .andExpect(
              jsonPath("$.error_description").value(ValidationMessages.TEMPLATE_NAME_MANDATORY));
    }
    ...
    void putTemplate_400_name_too_long() throws Exception {
      ...
      mockMvc.perform(MockMvcRequestBuilders.put(ENTITY_TEMPLATE_PATH + "/" + identifier)
          ...
          .andExpect(status().isBadRequest()).andExpect(jsonPath("$.error").value("BAD_REQUEST"))
          .andExpect(
              jsonPath("$.error_description").value(ValidationMessages.TEMPLATE_NAME_MAX_SIZE));
    }
    ...
    void putTemplate_400_name_invalid_pattern() throws Exception {
      ...
      mockMvc.perform(MockMvcRequestBuilders.put(ENTITY_TEMPLATE_PATH + "/" + identifier)
          ...
          .andExpect(status().isBadRequest()).andExpect(jsonPath("$.error").value("BAD_REQUEST"))
          .andExpect(
              jsonPath("$.error_description").value(ValidationMessages.TEMPLATE_NAME_FORMAT));
    }
