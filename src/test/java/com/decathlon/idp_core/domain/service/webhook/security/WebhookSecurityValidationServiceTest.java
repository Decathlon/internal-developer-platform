...
class WebhookSecurityValidationServiceTest {
  ...
  class NullBlankGuards {
    ...
    void shouldThrowWhenTypeIsNull() {
      ...
      assertThatThrownBy(() -> new WebhookSecurity(null, config))
          .isInstanceOf(WebhookSecurityConfigurationException.class)
    ...
    void shouldThrowWhenConfigIsNull() {
      assertThatThrownBy(() -> new WebhookSecurity(HMAC_SHA256, null))
          .isInstanceOf(WebhookSecurityConfigurationException.class)
          .hasMessageContaining("Webhook security config is mandatory");
    }
  }
  ...
  class KnownTypeDelegation {
    ...
    void shouldDelegateToHmacValidator() {
      ...
      var security = new WebhookSecurity(HMAC_SHA256, config);
  ...
  class UnregisteredType {
    ...
    void shouldThrowForUnregisteredType() {
      ...
      var security = new WebhookSecurity(JWT_BEARER,
          Map.of("jwks_uri", "https://example.com/.well-known/jwks"));
