...
class SearchFilterValidationServiceTest {
    ...
    private final SearchFilterValidationService service = new SearchFilterValidationService(repository);

    private static final SearchFilterNode EMPTY_FILTER =
            new SearchFilterNode.Group(LogicalConnector.AND, List.of());
    ...
    class FieldNameTests {
        ...
        void identifier_accepted() {
            assertThatCode(() -> service.validate(criterion("identifier", SearchOperator.EQ, "val"), null))
                    .doesNotThrowAnyException();
        }
        ...
        void relationsAsTarget_accepted() {
            assertThatCode(() -> service.validate(criterion("relations_as_target", SearchOperator.EQ, "val"), null))
                    .doesNotThrowAnyException();
        }
        ...
        void propertyField_accepted() {
            assertThatCode(() -> service.validate(criterion("property.language", SearchOperator.EQ, "val"), null))
                    .doesNotThrowAnyException();
        }
        ...
        void relationField_accepted() {
            assertThatCode(() -> service.validate(criterion("relation.api-link", SearchOperator.EQ, "val"), null))
                    .doesNotThrowAnyException();
        }
        ...
        void relationsAsTargetNameField_accepted() {
            assertThatCode(() -> service.validate(
                    criterion("relations_as_target.api-link.name", SearchOperator.EQ, "val"), null))
                    .doesNotThrowAnyException();
        }
        ...
        void unknownField_throws() {
            assertThatThrownBy(() -> service.validate(criterion("badField", SearchOperator.EQ, "val"), null))
                    .isInstanceOf(InvalidSearchQueryException.class)
        ...
        void relationsAsTarget_missingSubfield_throws() {
            assertThatThrownBy(() -> service.validate(
                    criterion("relations_as_target.api-link", SearchOperator.EQ, "val"), null))
                    .isInstanceOf(InvalidSearchQueryException.class);
        }
        ...
        void invalidField_nestedInGroup_throws() {
            var filter = new SearchFilterNode.Group(LogicalConnector.AND, List.of(
                    criterion("template", SearchOperator.EQ, "svc"),
    ...
    class NumericOperatorTests {
        ...
        void gt_onProperty_numericValue_accepted() {
            assertThatCode(() -> service.validate(criterion("property.port", SearchOperator.GT, "8080"), null))
                    .doesNotThrowAnyException();
        }
        ...
        void gte_onProperty_decimalValue_accepted() {
            assertThatCode(() -> service.validate(criterion("property.score", SearchOperator.GTE, "1.5"), null))
                    .doesNotThrowAnyException();
        }
        ...
        void gt_onTemplateField_throws() {
            assertThatThrownBy(() -> service.validate(criterion("template", SearchOperator.GT, "5"), null))
                    .isInstanceOf(InvalidSearchQueryException.class)
        ...
        void lt_onIdentifierField_throws() {
            assertThatThrownBy(() -> service.validate(criterion("identifier", SearchOperator.LT, "5"), null))
                    .isInstanceOf(InvalidSearchQueryException.class)
        ...
        void gt_nonNumericValue_throws() {
            assertThatThrownBy(() -> service.validate(criterion("property.port", SearchOperator.GT, "abc"), null))
                    .isInstanceOf(InvalidSearchQueryException.class)
        ...
        void lte_nonNumericValue_throws() {
            assertThatThrownBy(() -> service.validate(criterion("property.size", SearchOperator.LTE, "10MB"), null))
                    .isInstanceOf(InvalidSearchQueryException.class)
    ...
    private static SearchFilterNode.Criterion criterion(String field, SearchOperator op, String value) {
