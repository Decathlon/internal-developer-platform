...
VALUES ('770e8400-e29b-41d4-a716-446655440001',
        ...
        true,
        '{"type": "HMAC_SHA256", "config": {"header_name": "X-Hub-Signature-256", "secret_alias": "GITHUB_SECRET", "prefix": "sha256="}}'::jsonb);
...
VALUES ('770e8400-e29b-41d4-a716-446655440002',
        ...
        true,
        '{"type": "STATIC_TOKEN", "config": {"header_name": "X-Auth-Token", "secret_alias": "WEBHOOK_TOKEN"}}'::jsonb);
