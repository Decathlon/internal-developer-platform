...
-- Add column comment
COMMENT ON COLUMN entity_dynamic_mapping.action IS 'Action type for the entity dynamic mapping (UPDATE_ENTITY=0, UPDATE_PROPERTIES=1, UPDATE_RELATIONS=2, DELETE_ENTITY=3)';
