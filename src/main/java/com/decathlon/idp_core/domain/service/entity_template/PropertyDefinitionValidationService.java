...
public class PropertyDefinitionValidationService {
  ...
  ///
  /// **Contract:** Enforces the invariant that property names must be unique.
  /// Used
  ...
  public void validateTypeChanges(List<PropertyDefinition> existingProperties,
      List<PropertyDefinition> incomingProperties) {
    if (existingProperties == null || existingProperties.isEmpty() || incomingProperties == null
        || incomingProperties.isEmpty()) {
      return;
    }
  ...
  /// **Conflicting rules:** format, regex, and enum_values are mutually
  /// exclusive;
  ...
  /// @throws PropertyDefinitionRulesConflictException when rules defined violate
  ...
  /// @param propertyName name of the property (for error reporting)
  /// @param rules the property rules to validate
  /// @throws PropertyDefinitionRulesConflictException when any constraint is
  /// violated
  ...
  /// Validates rule compatibility and mutual exclusivity for STRING property
  /// rules.
  ///
  ...
  /// - enum_values and length constraints (max_length, min_length) are mutually
  /// exclusive
  ///
  /// @param propertyName name of the property (for error reporting)
  /// @param rules the property rules to validate
  /// @throws PropertyDefinitionRulesConflictException when incompatible rules are
  /// both present
  ...
  /// **Rejected rules:** format, enum_values, regex, max_length, min_length
  /// (string)
  /// **Constraints:** min_value ≤ max_value
  ///
  /// @param propertyName name of the property (for error reporting)
  /// @param rules the property rules to validate
  /// @throws PropertyDefinitionRulesConflictException when string rules are
  /// present
  ...
  /// @param propertyName name of the property (for error reporting)
  /// @param rules the property rules to validate
  /// @throws PropertyDefinitionRulesConflictException when any rule is set for
  /// BOOLEAN
  private void validateBooleanPropertyRules(String propertyName, PropertyRules rules) {
    if (rules.format() != null || rules.enumValues() != null || rules.regex() != null
