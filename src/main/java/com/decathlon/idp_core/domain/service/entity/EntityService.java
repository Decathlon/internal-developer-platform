...
public class EntityService {
  ...
  /// Partially updates an existing entity identified by template and entity identifiers.
  ///
  /// **Contract:** Validates template existence, then entity existence within the
  ...
  /// template constraints
  @Transactional
  public Entity patchEntity(String templateIdentifier, String entityIdentifier, @Valid Entity patchData) {
    ...
    Entity entityToSave = new Entity(
            existingEntity.id(),
            templateIdentifier,
            patchData.name() != null ? patchData.name() : existingEntity.name(),
            entityIdentifier,
