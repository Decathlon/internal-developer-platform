...
public final class SearchConstraints {
    ...
    /// Maximum nesting depth of a [com.decathlon.idp_core.domain.model.entity.SearchFilterNode] tree.
    ...
    public static final Set<String> ALLOWED_SORT_FIELDS = Set.of("identifier", "name", "templateIdentifier");
}
