...
/// Result of a dynamic mapping dry-run operation.
///
/// Contains the list of mapping outcomes (success, skipped, failure) without any
/// transport-specific semantics. Shared by every dry-run flow (single stateless mapping
/// and webhook-level aggregation).
