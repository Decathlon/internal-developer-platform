...
/// to create an entity, or update an entity, with property values that do not
/// conform to the validation rules defined in the entity's template. This
/// includes violations of required properties, type mismatches, and template
/// rules This enforces the business invariant that entities must conform to the
/// validation rules defined in their template's property definitions and
/// relation constraints.
///
/// **Why this exception exists:**
/// - Enforces business constraint that entity operations require valid property
///   values that conform to template rules
