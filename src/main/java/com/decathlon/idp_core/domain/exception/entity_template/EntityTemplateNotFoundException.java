...
public class EntityTemplateNotFoundException extends RuntimeException {
  ...
  /// are not available but the business rule violation still needs to be
  /// reported.
  ...
  /// the field name (for example, "identifier") and its value are known,
  /// providing
  /// clear context about what search criteria failed.
  ///
  /// @param fieldName the name of the field used in the search (for example,
  /// "identifier")
