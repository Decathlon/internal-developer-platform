...
/// Domain exception for duplicate [Entity] business entities within the same
/// template context.
///
...
/// This enforces the business invariant that entities must be unique within
/// their template context.
///
/// **Why this exception exists:**
/// - Enforces business constraint that entity operations require unique entities
