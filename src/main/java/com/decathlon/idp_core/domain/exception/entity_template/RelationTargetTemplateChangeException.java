...
public class RelationTargetTemplateChangeException extends RuntimeException {
  ...
  public RelationTargetTemplateChangeException(String relationName, String fromTarget,
      String toTarget) {
    super(
        String.format(RELATION_TARGET_TEMPLATE_CANNOT_CHANGE, relationName, fromTarget, toTarget));
  }
}
