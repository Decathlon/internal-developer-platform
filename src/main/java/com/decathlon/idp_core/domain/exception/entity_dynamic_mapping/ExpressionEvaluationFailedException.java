...
/// Thrown when JSLT expression evaluation fails on both current node and fallback root payload.
///
/// Indicates a critical mapping configuration issue: the expression is either syntactically invalid,
/// references non-existent paths, or the payload structure does not match the expected mapping definition.
@Getter
