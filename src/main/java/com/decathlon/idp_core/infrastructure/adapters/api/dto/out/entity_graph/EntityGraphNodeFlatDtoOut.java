...
///
/// Used by frontend visualization tools (React Flow, Vis.js, Cytoscape) that
/// expect entities and their relationships as separate, non-nested collections.
///
/// The optional `data` field is populated only when `include_data=true` is
/// requested, containing property name-to-value pairs for the entity.
...
public record EntityGraphNodeFlatDtoOut(
  ...
  /// mutation of the DTO after construction (EI_EXPOSE_REP2 / EI_EXPOSE_REP).
