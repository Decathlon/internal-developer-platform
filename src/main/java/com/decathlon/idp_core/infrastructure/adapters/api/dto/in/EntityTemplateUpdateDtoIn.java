 ...
 *
 * - Used as the request body for PUT operations on entity templates. - Composes
 * all updatable fields from {@link EntityTemplateCommonFields} and flattens
 * them into the top-level JSON using {@code @JsonUnwrapped}. - Fields are
 * validated using Jakarta Validation annotations. - Follows composition over
 * inheritance for maintainability and clarity.
 *
