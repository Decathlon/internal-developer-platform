...
public class EntityDtoOutMapper {
        ...
        /// lookups to minimize database queries. Builds summary maps for efficient
        /// relationship resolution across the entire page.
        ///
        /// @param entities                 paginated domain entities from repository
        ///                                 layer
        ...
        private Map<String, Object> mapPropertiesDto(Entity entity, EntityTemplate entityTemplate) {
                ...
                return entity.properties().stream()
                                ...
                                .collect(Collectors.toMap(
                                                Property::name,
                                                prop -> convertPropertyValue(prop,
                                                                propertiesDefinitions.get(prop.name()))));
        }
                ...
                return entity.relations() == null
                                ...
                                : entity.relations().stream()
                                                .collect(Collectors.groupingBy(
                                                                Relation::name,
                                                                Collectors.flatMapping(rel -> rel
                                                                                .targetEntityIdentifiers().stream()
        ...
        private Map<String, List<EntitySummaryDto>> mapRelationsAsTargetDto(Entity entity,
                ...
                return relationAsTargetSummaries.stream()
                                .collect(Collectors.groupingBy(
                                                ...
                                                Collectors.mapping(
                                                                r -> new EntitySummaryDto(r.sourceEntityIdentifier(),
                                                                                r.sourceEntityName()),
                                                                Collectors.toList())));
        }
                ...
                return targetIdentifiers.isEmpty()
                                ...
                                : entityService.getEntitiesSummariesByIndentifiers(targetIdentifiers)
                                                ...
                                                .collect(Collectors.toMap(
                                                                ...
                                                                es -> new EntitySummaryDto(es.identifier(),
                                                                                es.name())));
        }
