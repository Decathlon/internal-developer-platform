...
public class IngestionProcessor {
    ...
    private void applyMapping(String payload, EntityDynamicMapping mapping) {
        ...
        switch (mapping.action()) {
            case UPDATE_ENTITY -> handleUpsert(entity, exists);
            case UPDATE_PROPERTIES -> handleUpsertProperties(entity, exists);
            case UPDATE_RELATIONS -> handleUpsertRelations(entity, exists);
