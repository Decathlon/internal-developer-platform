...
public class InboundWebhookManagementController {
    ...
    public InboundWebhookDtoOut createInboundWebhook(@Valid @RequestBody InboundWebhookCreateDtoIn request) {
        WebhookConnector webhookConnector = webhookConnectorService.createWebhookConnector(inboundWebhookMapper.toDomain(request));
    ...
    @ApiResponse(responseCode = BAD_REQUEST_CODE, description = RESPONSE_INVALID_PAGINATION, content = {@Content(schema = @Schema(implementation = ApiExceptionHandler.ErrorResponse.class))})
    ...
    public Page<InboundWebhookDtoOut> getTemplatesPaginated(
        ...
        return webhookConnectorService.getAllWebhookConnector(pageable).map(inboundWebhookMapper::fromWebhookConnectorToDto);
    }
    ...
    @ApiResponse(responseCode = NOT_FOUND_CODE, description = RESPONSE_WEBHOOK_CONNECTOR_NOT_FOUND_IDENTIFIER, content = {@Content(schema = @Schema(implementation = ApiExceptionHandler.ErrorResponse.class))})
    ...
    @ApiResponse(responseCode = OK_CODE, description = RESPONSE_WEBHOOK_CONNECTOR_FOUND, content = {@Content(schema = @Schema(implementation = InboundWebhookDtoOut.class))})
    @ApiResponse(responseCode = NOT_FOUND_CODE, description = RESPONSE_WEBHOOK_CONNECTOR_NOT_FOUND_IDENTIFIER, content = {@Content(schema = @Schema(implementation = ApiExceptionHandler.ErrorResponse.class))})
    @GetMapping("/{identifier}")
    @ResponseStatus(OK)
    public InboundWebhookDtoOut getTemplateByIdentifier(@PathVariable String identifier) {
    ...
    @ApiResponse(responseCode = OK_CODE, description = RESPONSE_WEBHOOK_CONNECTOR_UPDATED, content = {@Content(schema = @Schema(implementation = InboundWebhookDtoOut.class))})
    @ApiResponse(responseCode = NOT_FOUND_CODE, description = RESPONSE_WEBHOOK_CONNECTOR_NOT_FOUND_IDENTIFIER, content = {@Content(schema = @Schema(implementation = ApiExceptionHandler.ErrorResponse.class))})
    @ApiResponse(responseCode = BAD_REQUEST_CODE, description = "Invalid request payload", content = {@Content(schema = @Schema(implementation = ApiExceptionHandler.ErrorResponse.class))})
    @ApiResponse(responseCode = CONFLICT_CODE, description = "Webhook connector title already exists", content = {@Content(schema = @Schema(implementation = ApiExceptionHandler.ErrorResponse.class))})
    @PutMapping("/{identifier}")
    @ResponseStatus(OK)
    public InboundWebhookDtoOut putWebhookConnector(@PathVariable String identifier, @Valid @RequestBody InboundWebhookCreateDtoIn request) {
        return inboundWebhookMapper.fromWebhookConnectorToDto(webhookConnectorService.updateWebhookConnector(identifier, inboundWebhookMapper.toDomainForUpdate(identifier, request)));
    }
}
