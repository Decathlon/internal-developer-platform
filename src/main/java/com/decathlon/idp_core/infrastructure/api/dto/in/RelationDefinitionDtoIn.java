...
import static com.decathlon.idp_core.infrastructure.api.configuration.SwaggerDescription.FIELD_RELATION_NAME;
import static com.decathlon.idp_core.infrastructure.api.configuration.SwaggerDescription.FIELD_RELATION_REQUIRED;
import static com.decathlon.idp_core.infrastructure.api.configuration.SwaggerDescription.FIELD_RELATION_TARGET_IDENTIFIER;
import static com.decathlon.idp_core.infrastructure.api.configuration.SwaggerDescription.FIELD_RELATION_TO_MANY;
import static com.decathlon.idp_core.infrastructure.api.configuration.SwaggerDescription.SCHEMA_RELATION_DEFINITION_IN;
