...
import static com.decathlon.idp_core.infrastructure.api.configuration.SwaggerDescription.ENDPOINT_DELETE_TEMPLATE_DESCRIPTION;
import static com.decathlon.idp_core.infrastructure.api.configuration.SwaggerDescription.ENDPOINT_DELETE_TEMPLATE_SUMMARY;
import static com.decathlon.idp_core.infrastructure.api.configuration.SwaggerDescription.ENDPOINT_GET_TEMPLATES_PAGINATED_DESCRIPTION;
import static com.decathlon.idp_core.infrastructure.api.configuration.SwaggerDescription.ENDPOINT_GET_TEMPLATES_PAGINATED_SUMMARY;
import static com.decathlon.idp_core.infrastructure.api.configuration.SwaggerDescription.ENDPOINT_GET_TEMPLATE_BY_IDENTIFIER_DESCRIPTION;
import static com.decathlon.idp_core.infrastructure.api.configuration.SwaggerDescription.ENDPOINT_GET_TEMPLATE_BY_IDENTIFIER_SUMMARY;
import static com.decathlon.idp_core.infrastructure.api.configuration.SwaggerDescription.ENDPOINT_POST_TEMPLATE_DESCRIPTION;
import static com.decathlon.idp_core.infrastructure.api.configuration.SwaggerDescription.ENDPOINT_POST_TEMPLATE_SUMMARY;
import static com.decathlon.idp_core.infrastructure.api.configuration.SwaggerDescription.ENDPOINT_PUT_TEMPLATE_DESCRIPTION;
import static com.decathlon.idp_core.infrastructure.api.configuration.SwaggerDescription.ENDPOINT_PUT_TEMPLATE_SUMMARY;
import static com.decathlon.idp_core.infrastructure.api.configuration.SwaggerDescription.NOT_FOUND_CODE;
import static com.decathlon.idp_core.infrastructure.api.configuration.SwaggerDescription.NO_CONTENT_CODE;
...
import static com.decathlon.idp_core.infrastructure.api.configuration.SwaggerDescription.RESPONSE_INVALID_TEMPLATE_DATA;
import static com.decathlon.idp_core.infrastructure.api.configuration.SwaggerDescription.RESPONSE_TEMPLATES_PAGINATED_SUCCESS;
import static com.decathlon.idp_core.infrastructure.api.configuration.SwaggerDescription.RESPONSE_TEMPLATE_CREATED;
import static com.decathlon.idp_core.infrastructure.api.configuration.SwaggerDescription.RESPONSE_TEMPLATE_DELETED;
import static com.decathlon.idp_core.infrastructure.api.configuration.SwaggerDescription.RESPONSE_TEMPLATE_FOUND;
import static com.decathlon.idp_core.infrastructure.api.configuration.SwaggerDescription.RESPONSE_TEMPLATE_NOT_FOUND_IDENTIFIER;
import static com.decathlon.idp_core.infrastructure.api.configuration.SwaggerDescription.RESPONSE_TEMPLATE_UPDATED;
...
import com.decathlon.idp_core.infrastructure.api.configuration.SwaggerConfiguration.TemplatePageResponse;
...
import com.decathlon.idp_core.infrastructure.api.mapper.entitytemplate.EntityTemplateMapper;
