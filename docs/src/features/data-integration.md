...
These HTTP routes map to the `InboundWebhookConfigurationController` methods for connector management.
...
| `mapping_identifiers` | Array of dynamic mapping identifiers referenced by the connector |
...
| `entity.name`       | JSLT expression for entity name               |
